  ...
  return (
    <section id="about" className="py-20">
      ...
      <motion.h2
        ...
        className="text-5xl sm:text-4xl font-bold mb-10 text-left"
      >
        ABOUT
      </motion.h2>
      ...
      <motion.div
        ...
        className="w-full max-w-3xl bg-[#5684AE]  shadow-lg rounded-xl p-4 md:p-8 border-l-4 border-[#5A7D6E] cursor-pointer transition-all duration-300"
      >
        <p className="mb-4 text-gray-900 text-sm md:text-base leading-7 md:leading-8 text-left">
        ...
        <p className="text-gray-900 text-sm md:text-base leading-7 md:leading-8 text-left">
